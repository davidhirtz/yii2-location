...
use davidhirtz\yii2\location\models\actions\ReorderFolder;
use davidhirtz\yii2\location\models\Folder;
use davidhirtz\yii2\location\models\queries\FolderQuery;
use davidhirtz\yii2\location\modules\admin\controllers\traits\FolderTrait;
...
class FolderController extends Controller
{
    ...
    public function actionCreate(?int $type = null): Response|string
    {
        ...
        if ($folder->load(Yii::$app->getRequest()->post()) && $folder->insert()) {
            $this->success(Yii::t('location', 'The folder was created.'));
    ...
    public function actionUpdate(int $id): Response|string
    {
        ...
        if ($folder->load(Yii::$app->getRequest()->post()) && $folder->update()) {
            $this->success(Yii::t('location', 'The folder was updated.'));
            return $this->refresh();
        }
    ...
    public function actionDelete(int $id): Response|string
    {
        ...
        if ($folder->delete()) {
            $this->success(Yii::t('location', 'The folder was deleted.'));
            return $this->redirect(['index']);
        }
